...
class CreateFuncionariosTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('funcionarios', function (Blueprint $table) {
            ...
            /* start añadidos ultimo */
            $table->string('tipo_contrato_descripcion',191)->nullable();
            $table->date('fecha_ini_tipo_contrato')->nullable();
            $table->date('fecha_fin_tipo_contrato')->nullable();
            $table->string('coordendax',191)->nullable();
            $table->string('coordenday',191)->nullable();
            /* end añadidos ultimo */
