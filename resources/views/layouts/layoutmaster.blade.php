...
<div id="page-container"
     class="sidebar-o sidebar-dark enable-page-overlay side-scroll page-header-fixed {{--para ocultar sidebar--}} {{--side-trans-enabled sidebar-mini--}}  {{--sidebar-o sidebar-dark enable-page-overlay side-scroll page-header-fixed--}}">
