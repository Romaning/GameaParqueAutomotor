{{--@foreach($datosinfraccion as $datosinfraccion)
@endforeach--}}
...
@section('content')
    ...
    <div class="block shadow p-2 mb-1 rounded" data-toggle="appear" data-class="animated bounceIn">
        ...
        <div class="block-content block-content-full">
            <form action="{{route('infraccion.update',$datosinfraccion->infraccion_id)}}" method="POST" enctype="multipart/form-data"
                                    ...
                                    <select class="js-select2 form-control"
                                        ...
                                        @foreach($vehiculos as $filavehiculo)
                                            <option
                                                ...
                                                {{$filavehiculo->placa_id==$datosinfraccion->placa_id? "selected":""}}>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control"
                                           value="{{$datosinfraccion->gestion}}"
                                           name="gestion" id="gestion" pattern="[0-9]+" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="js-flatpickr form-control bg-white"
                                           id="fecha_infraccion"
                                           value="{{$datosinfraccion->fecha_infraccion}}"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control"
                                           value="{{$datosinfraccion->boleta}}"
                                           name="boleta" id="boleta" >
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control"
                                           value="{{$datosinfraccion->condigo}}"
                                           name="condigo" id="condigo">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control"
                                           value="{{$datosinfraccion->descripcion}}"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control"
                                           value="{{$datosinfraccion->monto}}"
                                           name="monto" id="monto" type="number" step="any">
                                </div>
                            </div>
                        </div>
                        <div class="row">
