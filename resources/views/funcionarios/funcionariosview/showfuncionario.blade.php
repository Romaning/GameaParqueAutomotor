    ...
    <div class="block shadow p-2 mb-1 rounded" data-toggle="appear" data-class="animated bounceIn">
            ...
            <div class="row push">
                ...
                <div class="col-lg-8">
                            ...
                            <div class="row">
                                        ...
                                        <select class="js-select2 form-control" id="tipo_contrato_descripcion"
                                            ...
                                            @foreach($datostipocontrato as $filatipocontrato)
                                                <option
                                                    ...
                                                    {{$filatipocontrato->tipo_contrato_descripcion == $filafuncionario->tipo_contrato_descripcion? "selected":""}}
                                                >
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="js-flatpickr form-control bg-white"
                                               value="{{$filafuncionario->fecha_ini_tipo_contrato}}"
                                ...
                                <div class="col" id="div_fecha_fin_tipo_contr">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="js-flatpickr form-control bg-white"
                                               value="{{$filafuncionario->fecha_fin_tipo_contrato}}"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <input type="text" class="form-control js-maxlength d-none" name="coordenday"
                                       id="coordenday"
                                       value="{{$filafuncionario->coordenday}}"
                                       maxlength="191" data-always-show="true"
                                       data-placement="top">
                                <input type="text" class="form-control js-maxlength d-none" name="coordendax"
                                       id="coordendax"
                                       value="{{$filafuncionario->coordendax}}"
                                       maxlength="191" data-always-show="true"
                                       data-placement="top">
                            </div>
                        </div>
            ...
            <div class="block shadow p-2 mb-1 rounded" data-toggle="appear" data-class="animated bounceIn">
                <div class="block-header">
                    <h3 class="block-title">
                        ...
                        DATOS DE ASIGNACION
                        <a href="{{route('asignacion.show', $filaasignacion->asignacion_id)}}"
                           class="btn btn-info shadow" style="float: right;">IR A </a>
                    </h3>
                </div>
                <div class="block-content block-content-full">
                        ...
                        <div class="row push">
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group">
                                            <label for="numero_crpva">CRPVA: </label>
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group">
                                            <label for=numero_documento_importacion">NÚMERO DOCUMENTO DE
                                                IMPORTACION: </label>
                                            <input type="text" class="form-control"
        ...
        @section('js_script_import')
            ...
            <script>
                ...
                var marcador = new mapboxgl.Marker({draggable: false}).setLngLat([document.getElementById('coordenday').value, document.getElementById('coordendax').value]).addTo(map);
                coordinates.style.display = 'block';
                coordinates.innerHTML =
                    'Longitude: ' + document.getElementById('coordenday').value + '<br />Latitude: ' + document.getElementById('coordendax').value;
