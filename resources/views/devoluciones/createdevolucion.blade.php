                ...
                <div class="row push">
                    ...
                    <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="js-select2 form-control" id="asignacion_id" name="asignacion_id"
                                        ...
                                        @foreach($AsigIdPlacaIdCienAsignaciones as $filaasginados)
                                            <option value="{{$filaasginados->asignacion_id}}">
                                                <a href="#" class="btn btn-success">PLACA: {{$filaasginados->placa_id}}</a>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="fecha_devolucion">FECHA DEVOLUCION: <span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="identificador_acta_devolucion">NÚMERO ACTA DE TRANSFERENCIA: <span class="text-danger">*</span></label>
                            ...
                            <div class="col" data-toggle="appear" data-class="animated zoomIn">
                                ...
                                <div class="form-group">
                                    <div class="custom-file">
                                        ...
                                        <label class="custom-file-label" for="archivo_acta_devolucion">Cargar acta....</label>
                                    </div>
                                </div>
                                <!-- END Team Member -->
                            </div>
