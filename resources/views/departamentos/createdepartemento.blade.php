...
@section('nuevo_contenido_hero')
    @component('components.Hero.herotexto')
        @slot('titulo1','Registrar Dependencia')
        <li class="breadcrumb-item">SECCION 1</li>
        <li class="breadcrumb-item">DEPENDENCIAS</li>
        <li class="breadcrumb-item" aria-current="page">
            <a class="link-fx" href="">Form Dependencia</a>
        </li>
    @endcomponent
@endsection
{{--################### MODIFICACION HERO #################--}}
...
@section('content')
    ...
    <div class="block shadow p-2 mb-1 rounded">
        ...
        <div class="block-content block-content-full">
            <form action="{{route('departamento.store')}}" method="POST" enctype="multipart/form-data" id="form_subir_departamento">
                @csrf
                <div class="row push">
                    ...
                    <div class="col-lg-8 col-xl-5">
                        ...
                        <div class="form-group">
                            <label for="departamento_nombre">NOMBRE DE DEPENDENCIA: <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="departamento_nombre" name="departamento_nombre" placeholder="" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="js-select2 form-control" id="depende_id" name="depende_id"
                                ...
                                <option></option>
                                @foreach($datosdepartamento as $fila)
                                    <option
