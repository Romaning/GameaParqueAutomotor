...
@section('content')
    ...
    <div class="block shadow p-2 mb-1 rounded" data-toggle="appear" data-class="animated bounceIn">
        ...
        <div class="block-content">
            <form action="{{route('seguro.store.group')}}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('POST')
                <div class="row">
                    <div class="col-lg-4">
                        <div class="row">
                            <div class="col" data-toggle="appear" data-class="animated zoomIn">
                                ...
                                <div class="block">
                                    <div class="block-content">
                                        <img src="{{asset('assets/media/various/ecom_product11.png')}}"
                                             width="100%"
                                ...
                                <div class="form-group">
                                    <div class="custom-file">
                                        ...
                                        <input type="file" class="custom-file-input" data-toggle="custom-file-input"
                                               ...
                                               name="imagen_seguro" required>
                                        <label class="custom-file-label" for="input_imagen_seguro">Carge Imagen de
                                            Seguro...</label>
                                    </div>
                                </div>
                                <!-- END Team Member -->
                    ...
                    <div class="col-lg-7 col-xl-5">
                        <div class="form-group">
                            ...
                            <input type='text' value='{{date('Y')}}' class='form-control'
                        ...
                        <div class="form-group">
                            ...
                            <input type='text' value='' class='js-flatpickr form-control datepicker' name='fecha_vigencia' placeholder='Año-mes-dia' required>
                        </div>
                        <div class="form-group">
