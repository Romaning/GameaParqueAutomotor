                ...
                <table class="table table-bordered table-striped table-vcenter js-dataTable-buttons">
                    ...
                    <tr>
                        ...
                        <th style="width:10%;" class="text-sm-center font-size-sm">
                            <a href="{{route('seguro.previus.create')}}"
                        ...
                        <tr>
                            ...
                            <td class="justify-content-center">
                                <div class="row text-sm-center">
                                    <div class="col-sm-1">
                                        <a href="{{route('seguro.show.group',$filadatosseguro->grupo_id)}}"
                                    ...
                                    <div class="col-sm-1">
                                        <a href="{{route('seguro.edit.group',$filadatosseguro->grupo_id)}}"
                                           class="btn btn-sm btn-light push mb-md-0" data-toggle="tooltip"
                                           title="EDITAR">
                                    ...
                                    <div class="col-sm-1">
                                        <form action="{{route('seguro.destroy.group',$filadatosseguro->grupo_id)}}"
