...
@section('styles')
    ...
    <!-- Page CS DIRECTO PARA SHOW VEHÍCULO -->
...
@section('content')
    ...
    {{--<form action="{{route('reporte.vehiculo.download',$filavehiculo->placa_id)}}" method="post">
        @csrf
        @method('POST')
        <button>
            REPORTE
    ...
    <div class="block shadow p-2 mb-1 rounded" data-toggle="appear" data-class="animated bounceIn">
        <div class="block-header">
            <h3 class="block-title">DATOS VEHÍCULO</h3>
        </div>
        <div class="block-content block-content-full">
            ...
            <div class="row push">
                ...
                <div class="col-md-8 shadow p-2 mb-1 rounded">
                        <div class="row">
                            <div class="col-md-12">
                                <a href="{{route('reporte.vehiculo.show',$filavehiculo->placa_id)}}"
                                   class="btn btn-primary shadow p-2 mb-1 rounded" style="width:100%;">
                                    REPORTE COMPLETO
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col">
                                <label for=numero_documento_importacion">NÚMERO DOCUMENTO DE IMPORTACION: </label>
                                <input type="text" class="form-control"
