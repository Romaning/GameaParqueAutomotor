                ...
                <div class="row push">
                    <div class="col-lg-8 ">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col">
                                    <label for="numero_chasis">NÚMERO CHASIS: <span class="text-danger">*</span></label>
                                ...
                                <div class="col">
                                    <label for="numero_motor">NÚMERO MOTOR: <span class="text-danger">*</span></label>
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col">
                                    <label for="numero_documento_importacion">NÚMERO DOCUMENTO IMPORTACION: </label>
