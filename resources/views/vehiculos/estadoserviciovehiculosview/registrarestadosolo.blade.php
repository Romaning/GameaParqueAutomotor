...
@section('content')
    ...
    <div class="block shadow p-2 mb-1 rounded" data-toggle="appear" data-class="animated bounceIn">
        ...
        <form action="{{route('estservvehi.storesolo')}}" method="POST"
            ...
            @csrf
            @method('post')
            <h3 class="content-heading border-bottom mb-4 pb-2">CAMBIAR ESTADO SERVICIO DE VEHÍCULO (PARA ULTIMO REGISTRO EN
                BASE DE DATOS)
            </h3>
            <div class="row">
        ...
        <div class="block-content block-content-full">
            <div class="row push">
                <div class="col-md-12  shadow p-2 mb-1 rounded">
                    <h3 class="content-heading border-bottom mb-4 pb-2">ESTADO SERVICIO DE VEHÍCULO (ULTIMO REGISTRO EN
                        BASE DE DATOS)
                    </h3>
                    <div class="form-group">
                        <div class="row">
