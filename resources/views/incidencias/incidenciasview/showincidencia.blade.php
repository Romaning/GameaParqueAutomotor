...
@section('nuevo_contenido_hero')
    @component('components.Hero.herotexto')
        @slot('titulo1','Informacion Incidencia')
...
@section('content')
    ...
    <div class="block shadow p-2 mb-1 rounded" data-toggle="appear" data-class="animated bounceIn">
        ...
        <div class="block-content block-content-full">
            <form action="{{route('incidencia.update',$datosincidencia->incidencia_id )}}" method="POST" enctype="multipart/form-data"
                                    ...
                                    <select class="js-select2 form-control js-maxlength" id="placa_id"
                                        ...
                                        @foreach($datosvehiculos as $filavehiculo)
                                            <option
                                                ...
                                                {{$filavehiculo->placa_id == $datosincidencia->placa_id ? "selected":""}} >
                                    ...
                                    <select class="js-select2 form-control" id="ci" name="ci"
                                        ...
                                        @foreach($datosfuncionarios as $filafuncionario)
                                            <option
                                                ...
                                                {{$filafuncionario->ci == $datosincidencia->ci ? "selected":""}}>
                                                {{$filafuncionario->ci}}
                                            </option>
                                        @endforeach
                                    </select>
                                    ...
                                    <select class="js-select2 form-control" id="tipo_incidencia_descripcion"
                                        ...
                                        @foreach($datostipoincidencias as $filatipoincidencia)
                                            <option value="{{$filatipoincidencia->tipo_incidencia_descripcion}}"
                                                {{$filatipoincidencia->tipo_incidencia_descripcion== $datosincidencia->tipo_incidencia_descripcion ? "selected":""}}>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="js-flatpickr form-control bg-white"
                                           ...
                                           value="{{$datosincidencia->fecha_incidencia}}"
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group text-center">
                                    <label>VEHÍCULO EN MOVIMIENTO: </label>
                                    <div class="custom-control custom-switch custom-control-lg mb-2">
                                        ...
                                        <input type="checkbox"
                                               ...
                                               value="SI"
                                            {{$datosincidencia->vehiculo_en_movimiento == "SI" ? "checked":""}}
                                        >
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                           ...
                                           id="lugar_incidencia"
                                           value="{{$datosincidencia->lugar_incidencia}}"
