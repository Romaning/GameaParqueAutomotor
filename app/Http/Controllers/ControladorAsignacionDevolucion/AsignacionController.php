...
class AsignacionController extends Controller
{
    ...
    public function llevarAsigADevolucion($asignacion_id)
    {
        ...
        $AsigIdPlacaIdCienAsignaciones = DB::table('asignacions')
            ->select('asignacion_id', 'placa_id', 'ci', 'coord_asig','identificador_memorandum')
        ...
        return view('devoluciones.devolucionasignacion',
            compact('AsigIdPlacaIdCienAsignaciones',
                'funcionariosCi_NoEstanEnAsignaciones',
                'datosTipoCC'));
    }
