...
class EstadoServicioVehiculoController extends Controller
{
    ...
    public function show($estadoServicioVehiculo)
    {
        ...
        $datosestservvehi = DB::table('estado_servicio_vehiculos')
            ...
            ->get();
        $datosestado = EstadoService::all();
        return view('vehiculos.estadoserviciovehiculosview.showestadovehiculo', compact('datosestado','datosestservvehi'));
        /*$placa_id = "2720RKF";resources/views/vehiculos/estadoserviciovehiculosview/showestadovehiculo.blade.php
