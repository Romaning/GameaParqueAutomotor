...
Route::prefix('/seguro')->group(function () {
    ...
    Route::get('/index/group', 'ControladorVehiculo\SeguroController@indexGroup')->name('seguro.index.group');
    Route::get('/previus/create', 'ControladorVehiculo\SeguroController@previusOfCreate')->name('seguro.previus.create');
    Route::get('/create/group', 'ControladorVehiculo\SeguroController@createGroup')->name('seguro.create.group');
    Route::post('/store/group', 'ControladorVehiculo\SeguroController@storeGroup')->name('seguro.store.group');
    Route::get('/show/{grupo_id}/group', 'ControladorVehiculo\SeguroController@showGroup')->name('seguro.show.group');
    Route::get('/edit/{grupo_id}/group', 'ControladorVehiculo\SeguroController@editGroup')->name('seguro.edit.group');
    Route::put('/{grupo_id}/update/group', 'ControladorVehiculo\SeguroController@updateGroup')->name('seguro.update.group');
    Route::delete('/{grupo_id}/destroy', 'ControladorVehiculo\SeguroController@destroyGroup')->name('seguro.destroy.group');
...
/* &&&&&&&&&&&&&&&&&&&///////////////////////////////////////// R ///////////////////////////////////////&&&&&&&&&&&&&&&&&&& */
Route::prefix('/reporte/module/vehiculo')->group(function () {
    Route::get('{placa_id}/show', 'ControladorReporte\VehiculoReporteController@show')->name('reporte.vehiculo.show');
    Route::post('{placa_id}/download/module', 'ControladorReporte\VehiculoReporteController@downloadF')->name('reporte.vehiculo.download');
});
